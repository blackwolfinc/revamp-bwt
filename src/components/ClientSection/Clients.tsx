...
const Clients: React.FC = () => {
  return (
    <div className="h-screen w-screen bg-black flex flex-col lg:flex-row items-center justify-between px-[5vw] z-10">
    <div className='absolute lg:bottom-[3vh] right-0 w-full flex justify-center lg:justify-start mt-[10vh] lg:mt-[3vh]'> <h1 className='px-[6rem] text-[24px] lg:text-[46px]'>Our Project</h1></div>
      <div className="bg-gray-300/10 h-screen scale-[0.9] lg:mt-0 lg:h-[70vh] z-[20]  over lg:scale-100 w-screen lg:w-[50vw] rounded-lg shadow-2xl flex items-center justify-center">
        <Slider dots={false} infinite arrows autoplay  autoplaySpeed={6000} className="h-[70vh] w-full">
      ...
      <button className="z-50 lg:left-auto lg:mt-[-3rem] lg:hidden bottom-[20vh] lg:bottom-auto cursor-pointer absolute">
      ...
      <div className="lg:bg-white h-0 lg:h-[70vh] hidden lg:flex w-screen lg:w-[35vw] rounded-lg shadow-2xl p-[2rem] items-center justify-center relative">
        <button className="z-50 left-0 lg:left-auto lg:mt-[-3rem] bottom-[2vh] lg:bottom-auto cursor-pointer absolute">
